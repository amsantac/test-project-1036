...
def GetTrendyMapId_2000():
    ...
    image1 = ee.Image('LEDAPS/LE7_L1T_SR/LE70040562000023EDC00');
    image2 = ee.Image('LEDAPS/LE7_L1T_SR/LE70040572000023EDC00');
    image3 = ee.Image('LEDAPS/LE7_L1T_SR/LE70050552000046EDC00');
    image4 = ee.Image('LEDAPS/LE7_L1T_SR/LE70050562000110AGS01');
    image5 = ee.Image('LEDAPS/LT5_L1T_SR/LT50050572000278XXX02');
    image6 = ee.Image('LEDAPS/LE7_L1T_SR/LE70060552000005EDC00');
    image7 = ee.Image('LEDAPS/LE7_L1T_SR/LE70060562000005EDC00');
    image8 = ee.Image('LEDAPS/LE7_L1T_SR/LE70060572000005EDC00');
    image9 = ee.Image('LEDAPS/LT5_L1T_SR/LT50060582000029XXX02');
    image10 = ee.Image('LEDAPS/LE7_L1T_SR/LE70070562000348EDC00');
    image11 = ee.Image('LEDAPS/LE7_L1T_SR/LE70070572000076EDC00');
    image12 = ee.Image('LEDAPS/LE7_L1T_SR/LE70070582000348EDC00');
    ...
    #cloudiness = collection;
    return collection.getMapId(vizParams_L5L7)
    #return cloudiness.getMapId({'min':0,'max':10000, 'bands': 'B4,B5,B3'})
...
def GetTrendyMapId_2004():
    ...
    image1 = ee.Image('LEDAPS/LT5_L1T_SR/LT50040562004026CUB00');
    image2 = ee.Image('LEDAPS/LT5_L1T_SR/LT50040572004026CUB00');
    image3 = ee.Image('LEDAPS/LE7_L1T_SR/LE70050552004041EDC01');
    image4 = ee.Image('LEDAPS/LE7_L1T_SR/LE70050562004041EDC01');
    image5 = ee.Image('LEDAPS/LT5_L1T_SR/LT50050572004033CUB00');
    image6 = ee.Image('LEDAPS/LE7_L1T_SR/LE70060552004032EDC01');
    image7 = ee.Image('LEDAPS/LE7_L1T_SR/LE70060562004032EDC01');
    image8 = ee.Image('LEDAPS/LE7_L1T_SR/LE70060572004032EDC01');
    image9 = ee.Image('LEDAPS/LT5_L1T_SR/LT50060582004040CUB00');
    image10 = ee.Image('LEDAPS/LE7_L1T_SR/LE70070562004359EDC00');
    image11 = ee.Image('LEDAPS/LE7_L1T_SR/LE70070572004039EDC02');
    image12 = ee.Image('LEDAPS/LE7_L1T_SR/LE70070582004023ASN01');
